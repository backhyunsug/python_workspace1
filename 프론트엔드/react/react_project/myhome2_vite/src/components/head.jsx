...
function Head(){
    //자바스크립트가 class가 예약어임 jsx문법에서 className -> classNameName으로 바꿔써라
    //a 태그는 페이지 자체를 서버로 부터 다시 가져온다. SPA(Single Page Application)는 페이지 새로 
    //고침 하지 않고 비동기적으로 가져오면 알아서 다시 랜더링 Link 
    return (
